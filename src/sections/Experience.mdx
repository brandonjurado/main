...
<ExperienceCard
  ...
  company="H-E-B"
  relatedItems="Java, Dropwizard, Spring Boot, AWS Suite, TypeScript, PostgreSQL, Terraform, JUnit, Jest, GitLab CI/CD, Docker, Datadog, Postman
"
  bg="linear-gradient(to right, #DC291E 40%, ##C6251B 100%)"
>
...
<ExperienceCard
  ...
  years="July 2021 - July 2023"
  company="T-Mobile"
  relatedItems="Java, Angular, AWS S3, Spring Boot, TypeScript, Okta, Cassandra, JUnit, GitLab CI/CD, Kubernetes, Conducktor, Postman, Splunk
"
