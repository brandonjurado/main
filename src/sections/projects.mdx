...
<ProjectCard
  ...
  bg="linear-gradient(to right, #365EBF 0%, #36bf96 100%)"
>
...
<ProjectCard
  ...
  bg="linear-gradient(to right, #6bc843 0%, #43c8a0 100%)"
>
  <h2><FontAwesomeIcon class="text-warning" icon={faTrophy}/></h2>
...
<ProjectCard
  ...
  bg="linear-gradient(to right, #e92929 0%, #df7499 100%)"
>
  <h2><FontAwesomeIcon class="text-warning" icon={faTrophy}/></h2>
...
<ProjectCard
  ...
  bg="linear-gradient(to right, #009245 0%, #00928e 100%)"
>
  <h6>HackDFW 19'</h6>
